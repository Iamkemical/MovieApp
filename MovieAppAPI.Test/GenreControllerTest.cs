...
namespace MovieAppAPI.Test
{
    public class GenreControllerTest
    {
        ...
        public void GetAllGenre_NoCondition_Returns_OkObjectResult()
        {
            ...
            genreRepositoryMock.Setup(repo => repo.GetGenre()).Returns(It.IsAny<ICollection<GenreModel>>());
            // Act
        ...
        public void GetGenreById_Returns_OkObjectResult()
        {
            ...
            genreRepositoryMock.Setup(repo => repo.GetGenre(It.IsAny<Guid>())).Returns(genreModel);
            // Act
        ...
        public void CreateGenre_Returns_CreatedAtRoute()
        {
            ...
            genreRepositoryMock.Setup(repo => repo.GenreExist(It.IsAny<string>())).Returns(false);
            genreRepositoryMock.Setup(repo => repo.CreateGenre(It.IsAny<GenreModel>())).Returns(true);
            // Act
        ...
        public void UpdateGenre_Returns_NoContent()
        {
            ...
            genreRepositoryMock.Setup(repo => repo.UpdateGenre(It.IsAny<GenreModel>())).Returns(true);
            // Act
        ...
        public void DeleteGenre_Returns_NoContent()
        {
            ...
            genreRepositoryMock.Setup(repo => repo.GenreExist(It.IsAny<Guid>())).Returns(true);
            genreRepositoryMock.Setup(repo => repo.GetGenre(It.IsAny<Guid>())).Returns(genreModel);
            genreRepositoryMock.Setup(repo => repo.DeleteGenre(It.IsAny<GenreModel>())).Returns(true);
            // Act
